function SideBandFineTuningFit(Vmodes)
...
%                 SeqGSC=[SeqGSC,Pulse('NoiseEater674',Tstart,dic.vibMode(mode).coolingTime/5/N),...
%                                Pulse('674DoublePass',Tstart,dic.vibMode(mode).coolingTime/5/N),...
%                                Pulse('674DDS1Switch',Tstart,dic.vibMode(mode).coolingTime/5/N,...
%                                      'freq',dic.SinglePass674freq+dic.vibMode(mode).freq+dic.acStarkShift674)];
%                 Tstart=2+Tstart+dic.vibMode(mode).coolingTime/5/N;
%             end
