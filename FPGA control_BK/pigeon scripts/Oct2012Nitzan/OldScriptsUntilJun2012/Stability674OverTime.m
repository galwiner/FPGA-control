...
[freqstart widths]=FreqScan674Stab;

lines =InitializeAxes (dic.GUI.sca(11),...
    'Expt Index','Center Freq','674 Stability',...
    [ExptIndex(1) ExptIndex(end)],[-5 5],1);
grid(dic.GUI.sca(11),'on');
set(lines(1),'Marker','.','MarkerSize',10,'Color','b');

lines2 =InitializeAxes (dic.GUI.sca(10),...
    'Expt Index','Center Freq','674 Stability (difference)',...
    [ExptIndex(1) ExptIndex(end)],[-1 1],1);
...
for index1 = 1:length(ExptIndex)
    ...
    [freqcenter(index1) width(index1)]=FreqScan674Stab;
    dic.F674=freqcenter(index1);
...
if dic.AutoSaveFlag
    ...
    save(saveFileName,'freqcenter','width','showData','dicParameters','scriptText');
