...
if dic.curBeam==0 %674 beam horizontal at 45 deg to axial
    pulseTime=dic.T674*70;
    pulseAmp=1;
    valid = 0;
%    f674List = dic.F674+(-0.004:0.0002:0.004);    
    f674List = dic.F674+(-0.02:0.0008:0.02);    
...
elseif dic.curBeam==2
    ...
    pulseAmp=10;%2;
    valid = 0;
    f674List=dic.F674+(-0.02:0.0005:0.020);  
end
...
if (~isValidFit)||(peakValue<=60)||((max(dark)-min(dark))<=60)||(~initialstatus)
    disp('Invalid fit');
    FreqScan674;    
else
    dic.F674 = x0;
