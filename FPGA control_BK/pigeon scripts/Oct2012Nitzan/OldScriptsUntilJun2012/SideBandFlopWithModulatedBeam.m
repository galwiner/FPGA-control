function SideBandFlopWithModulatedBeam
...
% Puts 674 in MS mode
dic.setNovatech4Amp(1,1000); ChannelSwitch('DIO7','off');
SBDetuning=1.2; % in MHz
...
for index1 = 1:length(PulseTime)
    ...
    r=experimentSequence(PulseTime(index1),dic.F674+SBDetuning);
    rR=experimentSequence(PulseTime(index1),dic.F674-SBDetuning);
