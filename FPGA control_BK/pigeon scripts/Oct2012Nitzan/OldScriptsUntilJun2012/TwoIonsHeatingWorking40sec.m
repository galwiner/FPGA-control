...
%--------------- Save data ------------------
    ...
    function savethis
        ...
        save(saveFileName,'progress','waittime','RepeatedExpt','dark','initialCrystal','finalCrystal','chunksize','repetitions','index1','index2','Vkeith','Vcap','showData','dicParameters','scriptText');
