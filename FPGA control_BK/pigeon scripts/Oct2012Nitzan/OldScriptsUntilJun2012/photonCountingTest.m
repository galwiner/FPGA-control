function photonCountingTest
dic=Dictator.me;

InitializeAxes (dic.GUI.sca(1),'Photons #','Cases Counted #','Fluorescence Histogram',...
                [0 dic.maxPhotonsNumPerReadout],[],0);

    TimeList=0.025:0.025:0.3;
    %TimeList=1:1:10;
    %-------------- set GUI ---------------
...
%% ------------------------- Experiment sequence ------------------------------------    
    function [r,rep]=experimentSeq(DetectionTime)%create and run a single sequence of detection
        ...
        prog.GenRepeatSeq([Pulse('Repump1092',1,9),...
                           Pulse('OpticalPumping',2,5),...
                           Pulse('OnRes422',11,0.175),...
                           Pulse('PMTsAccumulate',11.950,DetectionTime)],4000);
        ...
        %prog.GenSeq(Pulse('OpticalPumping',0,-1,'freq',dic.F422onResCool));
        prog.GenFinish;
        %prog.DisplayCode;
