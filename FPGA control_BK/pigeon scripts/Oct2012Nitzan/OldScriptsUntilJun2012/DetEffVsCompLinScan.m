function [optVdcl,optVcomp]=DetEffVsCompLinScan(a,b)
dic=Dictator.me;
...
function savethis
    ...
    save(saveFileName,'a','b','waittime','Vcomp','AVdcl','photoncount','rep','initialCrystal','finalCrystal','dark','detectionEff','shelvingEff','chunksize','repetitions','idx2','showData','dicParameters','scriptText');
