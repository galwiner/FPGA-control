function valid=FreqScan674New(varargin)
dic=Dictator.me;
savedata=1;
...
if dic.SitOnItFlag
    ...
    for index1 = 1:length(f674List)
        ...
        pause(0.1);
        r=experimentSequence(FreqSinglePass,pulseTime,pulseAmp);%(FreqSinglePass,pulseTime,pulseAmp);
        dic.GUI.sca(1);
        hist(r,1:1:dic.maxPhotonsNumPerReadout);
        if dic.TwoIonFlag
