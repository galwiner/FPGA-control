function PhotonIonEntaglementRT
dic=Dictator.me;
% Set waveplates
dic.com.UpdateWavePlates(350,400);
%set the DDS2 amplitudes and freq
...
% ------------------------- Experiment sequence ------------------------------------    
    ...
    prog.GenRepeat
        ...
        prog.GenElseDo
            ...
            %prog.GenDDSFSKState(2,0);% set DDS2 phase to phase word 1(=0)
        prog.GenElseEnd;
    ...
    % Ion Qubit rotation  
    prog.GenRegOp('RegD=AI1toPhase');
    prog.GenRegOp('RegD*2^n',-2);
    prog.GenSeq([Pulse('674PulseShaper',2,piHalf-2),...
                 Pulse('RFDDS2Switch',3,piHalf,'phase',-1)]);
