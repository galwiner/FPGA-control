function MolmerSorensenEchoTestTimeScanbyParity
...
lines =InitializeAxes (dic.GUI.sca(11),...
    ...
    [Echoduration(1) Echoduration(end)],[-1 1],3);
...
%         disp(sprintf('%f %f %f %f',p0(index2),p1(index2),p2(index2),parity(index2)));
        AddLinePoint(darkCountLine(1),Echoduration(index2),parity(index2));
        
        AddLinePoint(darkCountLine(2),Echoduration(index2),p0(index2)/100);
        AddLinePoint(darkCountLine(3),Echoduration(index2),p2(index2)/100);
