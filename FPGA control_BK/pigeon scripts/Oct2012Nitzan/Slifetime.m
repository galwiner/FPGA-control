...
% WaitTime=1:40000:160001;
WaitTime=1:500:5000;
% WaitTime=1:20:500;
DoCheckOtherSpinState=1;
...
for index1 = 1:length(WaitTime)
    ...
    CrystalCheckPMT;  
    r=experimentSequence(dic.SinglePass674freq,dic.T674,100,WaitTime(index1));
...
%%------------------------ experiment sequence -----------------
    function r=experimentSequence(pFreq,pTime,pAmp,waittime)
        ...
        % shelving
        prog.GenSeq([Pulse('674DDS1Switch',2,dic.T674),Pulse('674DoublePass',1,dic.T674+2)]);     
