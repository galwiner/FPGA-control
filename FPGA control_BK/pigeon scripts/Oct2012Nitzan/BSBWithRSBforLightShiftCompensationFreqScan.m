...
%             dic.setNovatech('DoublePass','freq',dic.F674,'amp',1000);
            ...
            r=experimentSequence(Vmodes(modeInd),RabiFlopTime);
...
%--------------------------------------------------------------------
    function r=experimentSequence(mode,pulsetime)
        prog=CodeGenerator;
