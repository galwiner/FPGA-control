...
function r=experimentSequence(freq)
    ...
    prog.GenSeq(Pulse('674DDS1Switch',2,-1,'freq',dic.SinglePass674freq-LightShiftFreq,'amp',100));
...
%         Pulse('NoiseEater674',2,10),Pulse('674DoublePass',0,20)]);
    ...
    if DoLightShift
        prog.GenSeq([Pulse('674DDS1Switch',2,dic.TimeRF+20),...
                     Pulse('674DoublePass',2,dic.TimeRF+20),...
