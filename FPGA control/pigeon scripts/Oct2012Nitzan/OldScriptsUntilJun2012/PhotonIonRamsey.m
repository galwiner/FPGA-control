function PhotonIonRamsey(angle)
dic=Dictator.me;
% pi excitation 
dic.com.UpdateWavePlates(750,angle);
SecondpulseTime=7;
...
if (dic.AutoSaveFlag)
    ...
    save(saveFileName,'angle','meanDensityM','expResult','PulsePhase','expRep','condProb','showData','dicParameters','scriptText');
    ...
    prog.GenRepeat
        ...
        prog.GenPauseMemoryBlock;
           prog.GenSeq([Pulse('Repump1092',2,8),...
                         ...
                         Pulse('674PulseShaper',10,dic.TimeRF-1),...
                         Pulse('RFDDS2Switch',11,dic.TimeRF)]);
%             prog.GenSeq([Pulse('Repump1092',2,8),...
%                          Pulse('OpticalPumping',2,5)]);
    ...
    prog.GenSeq([Pulse('674PulseShaper',0,dic.piHalfRF-1),...
                 Pulse('RFDDS2Switch',1,dic.piHalfRF,'phase',mod(par,2*pi))]);    
