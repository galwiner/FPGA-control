function SidebandRabiScan674

dic=Dictator.me;

PulseTime=0.1:30:500;
BSBfreq=0.9742;
RSBfreq=-BSBfreq;
% ------------Set GUI axes ---------------
...
for index1 = 1:length(PulseTime)
    ...
    r=experimentSequence(PulseTime(index1),dic.updateF674+BSBfreq);
...
disp(sprintf('Side band Rabi=%.2f mu s',2*pi/Omega/4*1e6+0.1));
