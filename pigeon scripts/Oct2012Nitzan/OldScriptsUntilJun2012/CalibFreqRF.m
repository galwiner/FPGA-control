function CalibFreqRF
dic=Dictator.me;
%piHalf=7;% for FRF=3.401

freqList=dic.FRF+linspace(-0.001,0.001,3);
%-------------- set GUI ---------------
...
% ------------------------- Experiment sequence ------------------------------------    
    ...
    prog.GenSeq( Pulse('674DDS1Switch',5,-1,'freq',dic.F674,'amp',100) );
    ...
    prog.GenSeq(Pulse('674DDS1Switch',5,10,'freq',dic.F674+dic.FRF*1.2046));    % state flourescence detection
