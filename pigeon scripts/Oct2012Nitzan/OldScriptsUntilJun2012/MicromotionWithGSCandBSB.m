function MicromotionWithGSCandBSB

dic=Dictator.me;

Vmode=1;
detunning=-dic.vibMode(Vmode).freq+0.0079;%-0.02;
rep=300;
...
for index1 = 1:length(AVgrid)
    ...
    r=experimentSequence(PulseTime,dic.F674+detunning);
